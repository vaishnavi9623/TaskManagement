...
<div class="container mt-5">
    <div class="card shadow-lg rounded">
        <div class="card-body">
            ...
            <form id="create-team-form" action="{{ route('teams.store') }}" enctype="application/x-www-form-urlencoded" method="POST">
                @csrf
                <!-- Team Name -->
                <div class="row mb-4">
                    <div class="col-12">
                        <label for="team-name" class="form-label fw-bold" style="color: #333;">Team Name</label>
                        <input type="text" class="form-control" id="team-name" name="team_name" required>
                        @error('team_name')
                ...
                <div class="row mb-4">
                    <div class="col-12">
                        ...
                        <textarea class="form-control" id="team-description" name="description" rows="4" required></textarea>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-12 text-center">
                        <button type="submit" class="btn text-white fw-bold px-4 py-2" id="save-team-btn" style="font-weight: bold;background-color:#4dbfba;">Save Team</button>
                    </div>
                </div>
            </form>
        </div>
